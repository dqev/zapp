                  ...
                  <AnimatePresence>
                    {menuOpen && (
                      <motion.div
                        ...
                        className="absolute left-1/2 -translate-x-1/2 mt-2 w-36 sm:w-44 z-30 bg-[#1a1a1a] border border-white/10 rounded-xl shadow-2xl shadow-black/50 overflow-hidden p-1"
                      >
                        <button
                          type="button"
